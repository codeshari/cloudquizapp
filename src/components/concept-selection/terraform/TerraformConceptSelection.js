...
import './TerraformConceptSelection.css';

const TerraformConceptSelection = ({ concepts, onSelectConcept }) => {
  return (
    <div style={{ display: 'flex', flexDirection: 'row' }}>
      {/* Terraform Practice Quiz */}
      <div className="concept-selection">
        {/* Heading container */}
        <div className='heading-container'>
          <h1>Terraform Practice Quiz</h1>
        </div>
...
export default TerraformConceptSelection;
