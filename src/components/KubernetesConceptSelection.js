...
import './KubernetesConceptSelection.css';

const KubernetesConceptSelection = ({ concepts, onSelectConcept }) => {
  return (
    <div style={{ display: 'flex', flexDirection: 'row' }}>
      {/* Kubernetes Practice Quiz */}
      <div className="concept-selection">
        {/* Heading container */}
        <div className='heading-container'>
          <h1>Kubernetes Practice Quiz</h1>
        </div>
...
export default KubernetesConceptSelection;
